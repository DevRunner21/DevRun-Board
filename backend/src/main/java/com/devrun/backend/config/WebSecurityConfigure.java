package com.devrun.backend.config;


import com.devrun.backend.jwt.Jwt;
import com.devrun.backend.jwt.JwtAuthenticationFilter;
import com.devrun.backend.member.service.MemberService;
import com.devrun.backend.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.devrun.backend.oauth2.OAuth2AuthenticationSuccessHandler;
...
//  }
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http
            .authorizeRequests()
            .antMatchers("/api/v1/members/me").hasAnyRole("USER", "ATELIER","ADMIN")
            .antMatchers("/api/v1/posts").hasAnyRole("USER", "ATELIER","ADMIN")
